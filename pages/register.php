        ...
        <div class="max-w-md w-full">
            ...
            <div class="glass-effect rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div class="px-8 pt-8 pb-4 text-center relative">
                    ...
                    <h2 class="mt-6 text-3xl font-bold text-gray-900"><?php echo __('register_title'); ?></h2>
                                ...
                                <div class="mt-2">
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div id="passwordStrength"
                                            class="h-2 rounded-full transition-all duration-300 bg-gray-300"
                                            style="width: 0%"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="relative">
                                    ...
                                    <div class="absolute inset-y-0 right-0 pr-4 flex items-center cursor-pointer"
                                        ...
                                        <i id="confirmPasswordToggleIcon"
                                            class="fas fa-eye text-gray-400 hover:text-blue-500 transition-colors"></i>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="text-center mt-6">
                            <p class="text-sm text-gray-600">
                                ...
                                <a href="<?php echo url('login'); ?>"
                                    class="font-medium text-blue-600 hover:text-blue-500 transition-colors"><?php echo __('login'); ?></a>
                            </p>
                        </div>
                    </form>
                </div>
            ...
            <div class="mt-8 text-center">
                <p class="text-sm text-gray-500">
                    &copy; <?php echo date('Y'); ?> SIMADOK. <?php echo __('all_rights_reserved'); ?>
                </p>
            </div>
        </div>
    </div>
